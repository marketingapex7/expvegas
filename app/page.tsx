...
import { HomeTripBuilder } from "@/components/HomeTripBuilder";
...
export const metadata = {
  ...
  description: "Answer three quick steps and get a timed Las Vegas itinerary built around your dates, group size, budget, meals, events, and flexible stops.",
...
export default async function HomePage() {
  ...
  return (
    <>
      <HomeTripBuilder initialControls={defaultControls} minDate={getVegasToday()} />
      <HomeTripPreview />
